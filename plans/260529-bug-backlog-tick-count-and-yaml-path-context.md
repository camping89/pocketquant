...
Documented in `the retired migration-doubts notes (see `git log -- docs/migration-doubts-and-notes.md`)` (deferred 2026-05-07, still open 2026-05-25).
...
- `the retired migration-doubts notes (see `git log -- docs/migration-doubts-and-notes.md`)` (entry: tick_count)
...
### Symptom + doc reference
Documented in `the retired migration-doubts notes (see `git log -- docs/migration-doubts-and-notes.md`)`:
...
- `the retired migration-doubts notes (see `git log -- docs/migration-doubts-and-notes.md`)` (entry: YAML path)
