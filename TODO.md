...
- [ ] Test with real TradingView credentials (WebSocket quotes)
- [ ] Test OKX paper trading (demo mode), then live (small amounts)
- [ ] Performance reports — trade logs, equity curves, analytics dashboard
- [ ] Comprehensive test suite (unit + integration across all packages)
