...
def test_cme_hourly_is_the_2025_reference_count() -> None:
    """5910 = 259 sessions x 23h, less early closes.

    The only daily break is the 16:00-17:00 Chicago maintenance period. A
    15:15-15:30 pause that CME eliminated in June 2021 was once modelled here and
    moved this count to 5848; TradingView's bars show trading through it.
    """
