...
def _id(strategy_id: str, symbol: str, exchange: str, interval) -> str:
    return StrategySubscription.deterministic_id(strategy_id, symbol, exchange, interval)
...
# ---------------------------------------------------------------------------
# Normalisation: symbol/exchange case-insensitive
# ---------------------------------------------------------------------------
